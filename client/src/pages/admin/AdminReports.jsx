 ...
 * Changes for new store_products junction table: reports now aggregate through store_products
 */
...
const AdminReports = () => {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.text(`Role: Admin`, 20, 56);
      pdf.text(`Date Range: ${startDate || 'All'} - ${endDate || 'All'}`, 20, 63);

      pdf.setFontSize(16);
      pdf.text("Admin Store Report", pageWidth / 2, 80, { align: 'center' });
